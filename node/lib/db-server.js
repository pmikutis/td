...
function init() {
  ...
  var router = connect.router( function( app ) {
    ...
    app.post('/api/rest/trips',    api.rest.create)
    app.get('/api/rest/trips/:id', api.rest.read)
    app.get('/api/rest/trips',     api.rest.list)
    app.put('/api/rest/trips/:id', api.rest.update)
    app.del('/api/rest/trips/:id', api.rest.del)
